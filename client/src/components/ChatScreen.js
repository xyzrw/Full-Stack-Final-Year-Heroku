...
const ChatScreen = ({ userType }) => {
  ...
  useEffect(() => {
    ...
    const newSocket = new WebSocket(`ws://gympro-11a4c48ea502.herokuapp.com/':8080/${token}`);
...
//       const newSocket = new WebSocket('ws://ws://https://gympro-11a4c48ea502.herokuapp.com/:8081');
